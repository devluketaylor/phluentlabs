...
export default async function IssuePage({ params }: Props) {
    ...
    const jsonLd = {
        ...
        // Per-issue OG image (generated by the sibling opengraph-image route).
        ...
        url: canonical,
        inLanguage: "en",
        // Reading metadata derived from the word count (ISO 8601 duration).
        wordCount,
    ...
    // Breadcrumb trail (Home › Issues › <title>) — eligible for breadcrumb rich
    // results and clarifies site hierarchy for crawlers.
