...
## Now (active focus)
- [~] Tier 1: Mobile responsiveness pass — admin tables DONE (`62e49fa`); next up: public pages (homepage hero, issue pages, subscribe form) + dialogs at 375/390/414px
